...
def read_dict(f):
  ...
  for line in lines:
    ...
    if word not in dict:
      dict[word] = [phones]           ## phonemic transcriptions represented as list of lists of phones
    else:
      dict[word].append(phones)       ## add alternative pronunciation to list of pronunciations
  dictfile.close()
  return dict
